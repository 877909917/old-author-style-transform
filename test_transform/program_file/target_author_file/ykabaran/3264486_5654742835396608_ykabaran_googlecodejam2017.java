package googlecodejam2017;
 ...
 public class GoogleCodeJam2017 {
 	...
 	private static final String INPUT_NAME = "small1";
 
 	public static void main(String[] args) {
 		String filePath = "data" + File.separator + PROBLEM_NAME + File.separator + INPUT_NAME;
 		try (BufferedReader input = new BufferedReader(new FileReader(filePath + ".in"));
 			...
 			Logger.getLogger(GoogleCodeJam2017.class.getName()).log(Level.SEVERE, null, ex);
 		}
 	}
