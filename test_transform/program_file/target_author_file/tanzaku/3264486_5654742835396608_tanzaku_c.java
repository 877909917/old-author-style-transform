package qual;
 ...
 public class C {
 	...
 	class Config {
 		...
 		public static final String IN_FILE = "C-small-1-attempt0.in";
 	...
 	static class Interval implements Comparable<Interval> {
 		...
 		public int compareTo(Interval arg0) {
 			...
 			if (r - l == arg0.r - arg0.l) return l - arg0.l;
 			return (arg0.r - arg0.l) - (r - l);
 		}
 		
 		public List<Interval> split(int i) {
 			return Arrays.asList(new Interval(l, i - 1), new Interval(i + 1, r));
 		}
 	...
 	class ParallelSolver implements Runnable {
 		...
 		public void run() {
 			...
 			set.add(new Interval(1, n));
 			for (int i = 0; i < k - 1; i++) {
 				Interval in = set.pollFirst();
 				int j = in.center();
 				for (Interval in2 : in.split(j)) {
 					if (in2.l <= in2.r) set.add(in2);
 				}
 			}
